    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <a href="<?php echo site_url("dashboard/jabatan?id_unit_kerja=$id_unit_kerja&token=$token") ?>" class="btn btn-warning btn-sm">
                    Batal</a>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <?php echo form_open('jabatan/simpan',' class="needs-validation" novalidate ') ?>
                        <input type="hidden" name="id_unit_kerja" value="<?php echo $id_unit_kerja ?>">
                        <input type="hidden" name="token" value="<?php echo $token ?>">
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label for="nama_jabatan">Nama Jabatan</label>
                                    <input type="text" class="form-control" id="nama_jabatan" placeholder="Nama unit"
