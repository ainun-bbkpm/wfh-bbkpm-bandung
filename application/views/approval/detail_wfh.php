                        ...
                        <table id="example2" class="table table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2">Id WFH</th>

                                    <th rowspan="2">Tgl Abs</th>
                                    <th rowspan="2">Foto hadir</th>
                                    <th rowspan="2">Jam Masuk</th>
                                    <th rowspan="2">Jam pertengahan</th>
                                    <th rowspan="2">Jam Pulang</th>
                                    <th rowspan="2">Status</th>
                                    <th colspan="4">Kesehatan</th>
                ...
                <form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Nilai Kinerja (% 0-100)</label>
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            return '<a target="_balnk" href="<?php echo site_url('') ?>' + data + '">' + data + '</a>'
