    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <h1 class="mt-4">Data Usulan Penilaian</h1>

                <a href="<?php echo site_url('dashboard/penilaian/tambah') ?>" class="btn btn-success btn-sm">Tambah
                Usulan Penilaian</a>
                    ...
                    <table id="example" class="table table-striped table-bordered table-sm" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $penilaian->nama_penilaian ?></td>
                                

                                <td>
                                    <div class="btn-group" role="group" aria-label="...">
                                        <a href="<?php echo site_url("dashboard/penilaian/edit?id=$penilaian->id_penilaian&token=".sha1($penilaian->id_penilaian))  ?>" class="btn btn-primary btn-sm">Edit</a>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#hapus" data-id="<?php echo $penilaian->id_penilaian ?>"
                                            data-link="<?php echo site_url('penilaian/hapus')  ?>"
                                            >Hapus</button>
                                    </div>
                                </td>
                            </tr>
