    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <h3 class="mt-4">Data Usulan Penilaian</h3>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <?php echo form_open('penilaian/simpan',' class="needs-validation" novalidate ') ?>
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_penilaian" placeholder="Nama penilaian"
                                        name="nama_penilaian" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                                        Silahakan isi Nama penilaian
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
