...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <h3 class="mt-4">Edit Data Unit Kerja</h3>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <?php echo form_open('unit/update',' class="needs-validation" novalidate ') ?>
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label for="nama_unit_kerja">Nama Unit</label>
                                    <input type="hidden" name="id_unit_kerja" value="<?php echo  $unit->id_unit_kerja ?>">
                                    <input type="text" class="form-control" id="nama_unit_kerja" placeholder="Nama unit"
                                        name="nama_unit_kerja" value="<?php echo  $unit->nama_unit_kerja ?>" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" id="hak_akses_unit_kerja"
                                        ...
                                        ?>
                                        <option value="<?php echo $akses->id_hak_akses ?>" <?php echo  $akses->id_hak_akses == $unit->hak_akses_unit_kerja ?'selected':'' ?> ><?php echo $akses->nama_hak_akses ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
    ...
    var no_hp_unit = document.getElementById('no_hp_unit');
    no_hp_unit.addEventListener('keyup', function(e) {
        no_hp_unit.value = nominal(this.value);
    });
