...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <a href="<?php echo site_url("dashboard/pegawai/atasan_add?id=$id&token=$token") ?>" class="btn btn-primary btn-sm" >
                    Tambah Atasan</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="...">
                                        ...
                                        <a href="<?php echo site_url("dashboard/pegawai/atasan_edit?id_atasan=$atasan->id_atasan&id=$id&token=$token") ?>" 
                                            class="btn btn-primary btn-sm">Edit</a>


                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#hapus" data-id="<?php echo $atasan->id_atasan ?>"
                                            data-link="<?php echo site_url('pegawai/atasan_hapus')  ?>">Hapus</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="listpegawai" tabindex="-1" role="dialog" aria-labelledby="listpegawaiLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="nip_pegawai" id="nip_pegawai" value="<?php echo $pegawai->nip ?>">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="id_hak_akses"
                                name="id_hak_akses" required>
                                <?php
