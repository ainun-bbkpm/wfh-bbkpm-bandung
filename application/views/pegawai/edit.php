                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nik" placeholder="NIK pegawai"
                                        name="nik" value="<?php echo  $pegawai->nik ?>" >
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                                        Silahakan isi NIK pegawai
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="nip2">NIP pegawai</label>
                                    <input type="text" class="form-control" id="nip2" placeholder="nip pegawai"
                                        name="nip2" value="<?php echo  $pegawai->nip2 ?>" >
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                                        Silahakan isi Nip pegawai
                                    </div>
                                </div>
