...
<head>
  ...
  <title>Dashboard Login Remnuerasi </title>
...
<body class="text-center">
  ...
  <?php
  echo form_open('auth/cek_login', ' id="form_login"  class="form-signin"');
  // echo "<form>"
  ?>
  ...
  <div class="form-group ">
    <select class="form-control" name="login_sebagai">

      <option value="1">Admin</option>
      <option value="2">Approval</option>
      <option value="3" disabled>Penilai</option>
