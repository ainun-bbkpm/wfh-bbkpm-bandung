    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <a href="<?php echo site_url('dashboard/akses/tambah') ?>" class="btn btn-success btn-sm">Tambah
                    akses</a>
                ...
                <div class="table-responsive mt-4">
                    <table id="example" class="table table-striped table-bordered table-sm" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><?php echo $akses->id_hak_akses ?></td>
                                <td><?php echo $akses->nama_hak_akses ?></td>
                                

                                <td>
                                    <div class="btn-group" role="group" aria-label="...">
                                        <a href="<?php echo site_url("dashboard/akses/edit?id=$akses->id_hak_akses&token=".sha1($akses->id_hak_akses))  ?>" class="btn btn-primary btn-sm">Edit</a>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#hapus" data-id="<?php echo $akses->id_hak_akses ?>"
                                            data-link="<?php echo site_url('akses/hapus')  ?>"
                                            >Hapus</button>
                                    </div>
                                </td>
                            </tr>
