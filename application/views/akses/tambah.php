        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <?php echo form_open('akses/simpan',' class="needs-validation" novalidate ') ?>
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label for="nama_hak_akses">Nama Akses</label>
                                    <input type="text" class="form-control" id="nama_hak_akses" placeholder="Nama akses"
                                        name="nama_hak_akses" required>
